    ...
    <div
        ...
        <div class="">
            <form action="{{ route('rocks.index') }}" method="GET">
                @csrf
                <div class="mt-1 flex sm:border sm:border-gray-700 p-2 sm:rounded-full shadow-sm rounded-lg">
                <input
                    ...
                    <div class="flex items-center justify-center ">
                        <button class="bg-gray-800 transition border border-blue-700 hover:bg-gray-300 pl-3 pr-3 rounded-full m-2 p-1">
                            <x-icon-search class="h-7 w-auto text-gray-800 dark:text-gray-200"/>
                        </button>
                    </div>
